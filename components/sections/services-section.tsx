...
export function ServicesSection({ services: propServices, settings }: { services: ServiceData[]; settings?: SettingsData }) {
  ...
  // Handler que funciona tanto con click como con touch en iOS
  ...
  return (
    <section id="servicios" className="py-16 md:py-20 px-6 md:px-12 lg:px-16">
      <ScrollReveal>
        ...
        <h2
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-sans font-medium leading-tight max-w-2xl"
        ...
        <div className="flex flex-col">
          {services.map((service, i) => (
            <ScrollReveal key={service.id || service.title} delay={i * 0.08}>
              <button
                type="button"
                className="service-card w-full text-left py-7 border-b flex items-start justify-between gap-4 group cursor-pointer"
